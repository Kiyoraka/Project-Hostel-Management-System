...
- **Dedicated mobile renders, page by page** — each module ships its own mobile-native layout separate from the desktop grid:
  ...
  - **Other module pages** (Residents / Maintenance / Transportation / Billing / Staff / Helpdesk / Profile / Settings) currently use the responsive CSS adaptation from M1 and will get their own dedicated mobile renders in upcoming rounds.
